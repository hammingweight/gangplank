...
The metrics show that 101 predictions were performed and that the total spent on inference was 0.281 seconds. The last two lines are both 0.0; if instead
